        ...
        <div class="card radius-10">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="card-title mb-0">List Quote Inquiries</h5>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table align-middle mb-0" id="quotes-table" style="width: 100%">
            ...
            const table = $('#quotes-table').DataTable({
                ...
                columns: [
                    ...
                    { 
                        ...
                        name: 'sale_term',
                        render: function(data, type, row) {
                            return `Sale: ${data}<br>Pay: ${row.payment_term}<br>Curr: ${row.currency}`;
                        }
                    },
                    { 
                        data: 'message', 
