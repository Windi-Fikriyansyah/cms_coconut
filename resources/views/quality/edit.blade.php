...
@section('title', 'Edit Quality Section')

@section('content')
<div class="page-heading">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Edit Quality Section</h3>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('quality.index') }}">Quality Team</a></li>
...
<div class="page-content">
    <form action="{{ route('quality.update', $section->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <small class="text-muted">Upload gambar untuk background section quality.</small>
            </div>
            <div class="card-body">
    ...
    @endphp
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="{{ route('quality.index') }}" class="btn btn-secondary">Batal</a>
